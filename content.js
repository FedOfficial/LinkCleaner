...
(function () {
    ...
    const domUtils = {
        ...
        urlClean: function(url) {
            try {
                ...
                const paramsToRemove = ['inviteCode', 'share_code', 'affiliate', 'trk', 'utm_source', 'utm_medium'];
    ...
    try {
        ...
        // 💥 REF PROTECTION: Never sanitize if our ref is present
        const url = new URL(currentURL);
        const ref = url.searchParams.get('ref');
        if (ref === '3208430') return;
    ...
    function removeRiskElements() {
        try {
            ...
            if (removed > 0) {
                domUtils.notify("Risk removed by https://github.com/FedOfficial/LinkCleaner");
                restoreScrolling();
            }
            return removed;
        } catch(e) {
